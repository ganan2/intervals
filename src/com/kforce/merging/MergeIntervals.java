...
class MergeIntervals {
 ...
 /**
  * This method removes null and negative elements from the list, uses list of
  * Interval, returns list of Interval, throws NullPointerException and
  ...
  */
 public List<Interval> removeNullAndNegativeIntervals(List<Interval> list)
 ...
 /**
  * This method uses list of Interval and returns a list of Interval with forward
  * ranges.
  * 
  * @param list
  * @return
 ...
 /**
  * This method uses a list of Interval, sorts, and returns the merged list of
  * Interval.
  * 
  * @param list
  * @return
  */
 public List<Interval> getSortedAndMergedIntervals(List<Interval> globalList) {
  List<Interval> list = removeNullAndNegativeIntervals(globalList);
  if (list == null || list.size() == 0) {
   return null;
  }
 ...
 /**
  * This is the main method, uses array of String, logs the initial list of
  * Interval, and the sorted and merged list of Interval.
  * 
  * @param args
  */
...
//		list.add(new Interval(-4000, -5));
  ...
  List resultList = solution.getSortedAndMergedIntervals(list);
